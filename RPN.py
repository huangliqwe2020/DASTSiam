...
class RPN(nn.Module):
    ...
    def forward(self, examplar_feature_map, search_region_feature_map, BATCH_SIZE):
        ...
        adj_4_output = adj_4_output.reshape(-1, 36, 36)
        ...
        # ipdb.set_trace()
        depthwise_cross_reg = depthwise_cross_reg.reshape(-1, 256, 29, 29)
        depthwise_cross_cls = depthwise_cross_cls.reshape(-1, 256, 29, 29)
        ...
        return depthwise_cross_cls, depthwise_cross_reg
